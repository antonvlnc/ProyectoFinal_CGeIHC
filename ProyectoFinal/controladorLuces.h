...
private:
	...
	//Angulo m�ximo de la luz direccional, 180 para que el recorrido sea un semicirculo
	float maxAngle = 180.0f;
	//VAriable booleana indica si es de dia o de noche.
	GLboolean esDeDia;
	//El incremento del angulo. Esta en funcion de la duracion del dia el angulo m�ximo y la cantidad de fps
	float incrementoAngulo;
	//Angulo de la luz direccional, para poder calcular el vector de direcci�n de la luz.
	float angulo;
